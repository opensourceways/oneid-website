...
import { formValidator, getFitWidth, doValidatorForm, getCommunityParams } from 'shared/utils/utils';
import { useMarkdown } from 'shared/utils/useMarkdown';
import { modifyUser } from 'shared/api/api-center';
import { useCommonData } from 'shared/stores/common';
import privacyPolicy from '../shared/privacyPolicy.md?raw';
import privacyPolicy_en from '../shared/privacyPolicy_en.md?raw';
import legal from '../shared/legal.md?raw';
import legal_en from '../shared/legal_en.md?raw';
