export default {
  ...
  ENTER_COMPANYNAME: 'Company name',
  ...
  PASSWORD_TIP: 'The password needs to meet the following requirements',
  PASSWORD_LENGTH: '8 to 20 characters',
  PASSWORD_CONTENT: 'Must contain English, numbers, and special characters',
  ...
  SUBMIT: 'Submit',
  BINDING: 'Bind',
  BINDING_CUR_ACCOUNT: 'Bind Account',
  BINDING_CUR_ACCOUNT_TIP: 'You can sign in to your account using your phone number',
