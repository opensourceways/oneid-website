export default {
  ...
  MODIFY_EMAIL_TIP: 'After successfully modifying the email, you need to log in again',
  CURRENT_EMAIL: 'Email',
  ...
  MODIFY_PHONE_TIP: 'After successfully changing the phone number, you need to log in again',
  CURRENT_PHONE: 'Phone',
